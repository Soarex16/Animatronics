...
public class FXWisp extends EntityFX {
    ...
    public static final ResourceLocation particles = new ResourceLocation(FXHelper.MISC_WISP_LARGE);
    ...
    public static void dispatchQueuedRenders(Tessellator tessellator) {
        FXHelper.wispFxCount = 0;
        FXHelper.depthIgnoringWispFxCount = 0;
    ...
    private void renderQueued(Tessellator tessellator, boolean depthEnabled) {
        if(depthEnabled)
            FXHelper.wispFxCount++;
        else FXHelper.depthIgnoringWispFxCount++;
