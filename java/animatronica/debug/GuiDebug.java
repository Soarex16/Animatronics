...
public class GuiDebug extends GuiBase{
	...
	public ElementTextField text;
	
	public GuiDebug(Container container, TileEntity tile) {
		super(container, tile);
		this.elementList.add(text = new ElementTextField(20,48, "", 4210752, false));
	}
	
	public void drawGuiContainerForegroundLayer(int mouseX, int mouseY){
		long time = 2000 - Minecraft.getMinecraft().theWorld.getTotalWorldTime()%2000;
	...
	public void drawGuiContainerForegroundLayer(int mouseX, int mouseY){
    	...
    	fontRendererObj.drawString("Time before cook:" + (2000 - (Minecraft.getMinecraft().theWorld.getWorldTime()%2000)) + "ticks", 25, 35, 4210752);
	}
