...
import animatronics.utils.misc.RenderUtils;
...
public class FXLightningBolt extends EntityFX {
	   ...
	   public void renderParticle(Tessellator tessellator, float partialframe, float cosyaw, float cospitch, float sinyaw, float sinsinpitch, float cossinpitch) {
	      ...
	      if(renderentity.getDistance(this.posX, this.posY, this.posZ) <= (double)visibleDistance) {
	         ...
	         Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation("animatronics", "textures/misc/p_large.png"));
	         ...
	         Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation("animatronics", "textures/misc/p_small.png"));
	         tessellator.startDrawingQuads();
	         tessellator.setBrightness(15728880);
	         ...
	         GL11.glPopMatrix();
	         Minecraft.getMinecraft().renderEngine.bindTexture(RenderUtils.getParticleTexture());
	         tessellator.startDrawingQuads();
	      }
	   }
