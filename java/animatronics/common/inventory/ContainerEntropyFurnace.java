...
public class ContainerEntropyFurnace extends Container{

	public TileEntityEntropyFurnace furnace;

	public ContainerEntropyFurnace(InventoryPlayer inventory, TileEntityEntropyFurnace tile) {
		furnace = tile;
		addSlotToContainer(new Slot(tile, 0, 80-18, 44));
		addSlotToContainer(new SlotLocked(tile, 1, 80+18, 44));
