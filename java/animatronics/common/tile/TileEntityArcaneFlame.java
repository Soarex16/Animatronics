	...
	public void updateEntity() {
        ...
        if (this.worldObj.isRemote) {
            ...
            if (this.worldObj.rand.nextInt(15 - Animatronics.proxy.particleCount(4)) == 0) {
            	Animatronics.proxy.wispFX3(this.worldObj, this.xCoord + 0.5f, this.yCoord + 0.5f, this.zCoord + 0.5f, this.xCoord + 0.4f + this.worldObj.rand.nextFloat() * 0.2f, this.yCoord + 0.5f, this.zCoord + 0.4f + this.worldObj.rand.nextFloat() * 0.2f, 0.25f, 1, true, -0.02f);
            }
            Entity player = Minecraft.getMinecraft().thePlayer;
            Animatronics.proxy.wispFX4(worldObj, xCoord+0.5, yCoord+0.5, zCoord+0.5, player, 4, true, 0);
        }
	}
